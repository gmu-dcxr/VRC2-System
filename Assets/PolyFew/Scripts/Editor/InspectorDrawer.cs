...
#region Title Header
                ...
                if(isPlainSkin)
                {
                    if (GUILayout.Button("<size=14><b>POLY FEW</b></size> <size=7><b>v7.77</b></size>", style)) { toolMainFoldout = !toolMainFoldout; }
                }
                else
                {
                    if (GUILayout.Button("<size=14><color=#A52A2AFF><b>POLY FEW</b></color></size> <size=7><b><color=#A52A2AFF>v7.77</color></b></size>", style)) { toolMainFoldout = !toolMainFoldout; }
                }
                ...
                if (GUILayout.Button(content, GUILayout.Width(24), GUILayout.Height(24)))
                {
                    Application.OpenURL("https://brainfailpro.github.io/polyfewhome/");
                }
                ...
                if (GUILayout.Button(content, GUILayout.Width(24), GUILayout.Height(24)))
                {
                    Application.OpenURL("https://brainfailpro.github.io/polyfewhome/polyfew_runtime_api_docs/");
                }
...
#region TITLE HEADER
            ...
            content = new GUIContent();
            if (isPlainSkin) { content.text = "<size=13><b>BATCH FEW</b></size> <size=7><b>v2.51</b></size>"; }
            else { content.text = "<size=13><b><color=#A52A2AFF>BATCH FEW</color></b></size> <size=7><b><color=#A52A2AFF>v2.51</color></b></size>"; }
