...
public class ControllerTruck : MonoBehaviour {
	[Header("If provided FPSController")]
	public KeyCode exitEnterCar_Key = KeyCode.Tab;
	public Transform m_fPSController;
	private bool exitEnterCar_Bool = true;
	[HideInInspector]
	public bool OnFps = false;
	[HideInInspector]
	public bool fps_Bool = false;
	[HideInInspector]
	public Rigidbody rig;
	[HideInInspector]
	public bool startTruck = false;
	[HideInInspector]
	...
	[HideInInspector]
	public Transform wheelTransformBL_For;
	[HideInInspector]
	public Transform wheelTransformBR_For;
	[HideInInspector]
	public Transform wheelTransformBL_Back;
	[HideInInspector]
	public Transform wheelTransformBR_Back;
	//Wheel Colleder
	[HideInInspector]
	public WheelCollider wheelCol_FL;
	[HideInInspector]
	public WheelCollider wheelCol_FR;
	[HideInInspector]
	public WheelCollider wheelCol_BL_For;
	[HideInInspector]
	public WheelCollider wheelCol_BR_For;
	[HideInInspector]
	public WheelCollider wheelCol_BL_Back;
	[HideInInspector]
	public WheelCollider wheelCol_BR_Back;
	[Header("Motor")]
	public float speedEngine = 200f;
	...
	public float steer = 33f;
	private float m_Horizontal = 0f;
	[Header("Brace")]
	public float brace = 650f;
	public float coastBraking = 320f;
	public float inertiaBrake = 430f;
	[Header("Hand Brake")]
	public KeyCode parkingBrake = KeyCode.Space;
	public float parkingBrakePower = 1000f;
	[HideInInspector]
	public bool parkingBrake_Bool = true;
	[Header("Sound")]
	public float volumeEngine = 0.544f;
	public float volumeRevers = 0.560f;
	public float volumeLight = 1f;
	[HideInInspector]
	public AudioSource s_Engine;
	[HideInInspector]
	public float pitchSoundTruck = 0.6f;
	...
	[HideInInspector]
	public AudioSource s_Revers;
	[HideInInspector]
	public AudioSource s_Turn;
	[HideInInspector]
	public AudioSource s_StartStop;
	private AudioClip S_start;
	private AudioClip S_stop;
	[HideInInspector]
	public Light revers_L;
	[HideInInspector]
	public Light revers_R;
	[HideInInspector]
	public Light stop_L;
	[HideInInspector]
	public Light stop_R;
	[HideInInspector]
	public Light turnSignal_L;
	[HideInInspector]
	public Light turnSignal_R;
	[HideInInspector]
	public Light turnSignalPanel_L;
	[HideInInspector]
	public Light turnSignalPanel_R;
	public KeyCode leftTurn = KeyCode.Q;
	public KeyCode RightTurn = KeyCode.E;
	public KeyCode turnSignal = KeyCode.G;
	[HideInInspector]
	public bool leftTurn_Bool = true;
	[HideInInspector]
	public bool RightTurn_Bool = true;
	[HideInInspector]
	public bool turnSignal_Bool = true;
	[Header("Manipulator")]
	public KeyCode powrManipulator = KeyCode.F;
	...
	[HideInInspector]
	public bool blockOnManip = true;
	[HideInInspector]
	public bool blockOnManip_Cargo = true;
	[HideInInspector]
	public bool blockManip_Bool = false;
	[Header("Lift Truck Manipulator")]
	public KeyCode horizontalLiftTruck = KeyCode.Alpha1;
	...
	[HideInInspector]
	public bool onManip = true;
	[HideInInspector]
	public Canvas truckCanvas;
	[HideInInspector]
	public Canvas EnterCanvas;
	[HideInInspector]
	public Image connectedCargoIm;
	[HideInInspector]
	public Image EnterExitCar_Im;
	...
	[HideInInspector]
	public Crable m_ScriptCrable;
	[HideInInspector]
	public HookManip m_ScriptHook;
		...
		if (fps_Bool == false) {
			if (startTruck == true) {
				if (Input.GetKeyDown (powrManipulator) && onManip == true && blockManip_Bool == true && speedI == 0) {
					...
					onManip = false;
				} else if (Input.GetKeyDown (powrManipulator) && onManip == false && blockOnManip == true && blockOnManip_Cargo == true) {
	...
	public void Motor(){
		if (lowGear_Bool == true) {
			...
			gameObject.GetComponent<Rigidbody> ().velocity = Vector3.ClampMagnitude (gameObject.GetComponent<Rigidbody> ().velocity, maxSpeedEngine);
	...
	public void SoundEngineTruck(){
		engineRPM = Mathf.Clamp ((((Mathf.Abs ((wheelCol_FL.rpm + wheelCol_FR.rpm)) * gearShiftRate) + minEngineRPM)) / (float)(currentGear + 1), minEngineRPM, maxEngineRPM);
		s_Engine.pitch = Mathf.Lerp (s_Engine.pitch, Mathf.Lerp (pitchSoundTruck, 2f, (engineRPM - minEngineRPM / 1.82f) / (maxEngineRPM + minEngineRPM)), Time.deltaTime * 5f);
	}
	public void Revers(){
