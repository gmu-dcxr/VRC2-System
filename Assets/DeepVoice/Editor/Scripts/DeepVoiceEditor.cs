...
namespace AiKodexDeepVoice
{
    public class DeepVoiceEditor : EditorWindow
    {
        ...
        public enum Voice
        {
            Obama, Biden, Trump, Queen, Batman, Andrew, Anime_Girl, Valentina,Wayne,Jan, Noah, Lily, Ethan, Sophia, Olivia, Ruby, Lucas, John
        };
        ...
        string[] previewMonoMultiVoicesString = { "Obama", "Biden", "Trump", "Queen", "Batman", "Andrew", "Anime_Girl","Valentina","Wayne","Jan", "Noah", "Lily", "Ethan", "Sophia", "Olivia", "Ruby", "Lucas", "John" };
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("                Version 1.1", subStyle);
            ...
            if (500 - text.Length >= 0)
                EditorGUILayout.LabelField($"{500 - text.Length} char", style, GUILayout.MaxWidth(80));
            else
                EditorGUILayout.LabelField($"{500 - text.Length} char", styleError);
