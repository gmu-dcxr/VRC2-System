...
namespace VRC2
{
    [CustomEditor(typeof(NetworkOVRSkeleton))]
    public class NetworkOVRSkeletonEditor : OVRSkeletonEditor
    {
        public override void OnInspectorGUI()
        {
            var skeleton = (NetworkOVRSkeleton)target;
        ...
        private static void DrawBonesMapping(NetworkOVRSkeleton skeleton)
        {
    ...
    public static class NetworkOVRSkeletonEditorExtensions
    {
        ...
        public static void AutoMapBones(this NetworkOVRSkeleton customSkeleton, NetworkOVRSkeleton.RetargetingType type)
        {
            try
            {
                switch (type)
                {
                    case NetworkOVRSkeleton.RetargetingType.OculusSkeleton:
                        customSkeleton.AutoMapBonesFromOculusSkeleton();
                        break;
                    default:
                        throw new InvalidEnumArgumentException($"Invalid {nameof(NetworkOVRSkeleton.RetargetingType)}");
                }
            }
            catch (Exception e)
            {
        ...
        public static void TryAutoMapBonesByName(this NetworkOVRSkeleton customSkeleton)
        {
            customSkeleton.AutoMapBonesFromOculusSkeleton();
        }

        internal static void AutoMapBonesFromOculusSkeleton(this NetworkOVRSkeleton customSkeleton)
        {
