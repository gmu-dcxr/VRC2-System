...
{
    public class ClampGrabbable : PointableElement, IGrabbable
    {
        ...
        internal void SpawnClamp()
        {
            ...
            var prefab = GlobalConstants.clampNetworkPrefabRef;
            ...
            runner.Spawn(prefab, pos, t.rotation, localPlayer);
        }
        ...
        private void NonSpawnedClampProcessPointerEvent(PointerEvent evt)
        {
            switch (evt.Type)
            {
        ...
        private void SpawnedClampProcessPointerEvent(PointerEvent evt)
        {
            switch (evt.Type)
            {
                case PointerEventType.Select:
        ...
        public override void ProcessPointerEvent(PointerEvent evt)
        {
            ...
            {
                SpawnedClampProcessPointerEvent(evt);
            }
            else
            {
                NonSpawnedClampProcessPointerEvent(evt);
            }
        }
