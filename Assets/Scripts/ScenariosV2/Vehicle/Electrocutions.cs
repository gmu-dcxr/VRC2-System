...
namespace VRC2.ScenariosV2.Vehicle
{
    public class Electrocutions : Base
    {
        ...
        public void Electrocutions_normals_1()
        {
        ...
        public void Electrocutions_normals_2()
        {
            print("Invoked Electrocutions_normals_2");
        }

        public void Electrocutions_accidents_1()
        {
            print("Invoked Electrocutions_normals_1");
            baselineS8.ShowWarning(2);
            baselineS8.On_BaselineS8_2_Start();
        ...
        public void Electrocutions_accidents_2()
        {
            print("Invoked Electrocutions_accidents_2");
        }

        public void Electrocutions_accidents_3()
        {
        ...
        public void Electrocutions_accidents_4()
        {
            print("Invoked Electrocutions_accidents_4");
        }

        public void Electrocutions_accidents_5()
        {
        ...
        public void Electrocutions_accidents_6()
        {
