...
{
    public class NetworkGrabbable : PointableElement, IGrabbable
    {
        [SerializeField, Interface(typeof(ITransformer))] [Optional(OptionalAttribute.Flag.AutoGenerated)]
        public UnityEngine.Object _oneGrabTransformer = null;

        [SerializeField, Interface(typeof(ITransformer)), Optional]
        public UnityEngine.Object _twoGrabTransformer = null;
        ...
        [HideInInspector]public ITransformer _activeTransformer = null;
        [HideInInspector]public ITransformer OneGrabTransformer;
