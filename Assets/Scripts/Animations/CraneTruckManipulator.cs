...
public class CraneTruckManipulator : MonoBehaviour {
    
	public ControllerTruck m_ScriptM;
	[HideInInspector]
	public Transform obj_Manipulator;
	[HideInInspector]
	public int checkManip = 0;
	[HideInInspector]
	public Transform support_FL_Vertical;	
	private bool support_FL_Vertical_Bool = true;
	[HideInInspector]
	public Transform support_FR_Vertical;
	private bool support_FR_Vertical_Bool = true;
	[HideInInspector]
	public Transform support_FL_Horizontal;
	...
	//Piston
	[HideInInspector]
	public Transform pistonUp;
	[HideInInspector]
	public Transform pistonDown;
	[HideInInspector]
	public Transform checkDistanceHook_A;
	[HideInInspector]
	public Transform checkDistanceHook_B;
	private float angleRotArrow_float = 0;
	//Wing Manip
	[HideInInspector]
	public Transform wingManip;
	[HideInInspector]
	...
	[HideInInspector]
	public bool uiManip_Bool = true;
	[HideInInspector]
	public Text hook_Text;
	//Bloc Crable
	[HideInInspector]
	public bool block_Left = true;
	[HideInInspector]
	public bool block_Right = true;
	[HideInInspector]
	public bool block_For = true;
	[HideInInspector]
	public bool block_Back = true;
	[HideInInspector]
	public bool block_Down = true;
	[HideInInspector]
	public Transform obl_Crable;
	[HideInInspector]
	public Transform pisCrableUp;
	[HideInInspector]
	public Transform pisCrableDown;
	[HideInInspector]
	public Transform pisCrableUp_Parent;
	[HideInInspector]
	public Transform pisCrableDown_Parent;
		...
		if (Input.GetKey (m_ScriptM.backArrow) && block_Back == true) {
			if (checkManip == 1 || checkManip == 2) {
				if (endPos_Arrow3 == new Vector3 (0.0006604248f, -0.06289651f, -0.09905349f)) {
					arrowForward2.transform.localPosition = Vector3.MoveTowards (arrowForward2.transform.localPosition, new Vector3 (0.0006269385f, 0.1260378f, -0.1995553f), m_ScriptM.speedForward * Time.deltaTime);
				}
				if (endPos_Arrow4 == new Vector3 (0.005361533f, -0.05230227f, 0.1309257f)) {
					arrowForward3.transform.localPosition = Vector3.MoveTowards (arrowForward3.transform.localPosition, new Vector3 (0.0006604248f, -0.06289651f, -0.09905349f), m_ScriptM.speedForward * Time.deltaTime);
				}
				arrowForward4.transform.localPosition = Vector3.MoveTowards (arrowForward4.transform.localPosition, new Vector3 (0.005361533f, -0.05230227f, 0.1309257f), m_ScriptM.speedForward * Time.deltaTime);
			} else if (checkManip == 3) {
				if (endPos_Arrow3 == new Vector3 (0.0005618262f, 0.0002853314f, -0.04771918f)) {
					arrowForward2.transform.localPosition = Vector3.MoveTowards (arrowForward2.transform.localPosition, new Vector3 (-0.01917278f, 0.07633314f, -3.588468f), m_ScriptM.speedForward * Time.deltaTime);
				}
					if (endPos_Arrow4 == new Vector3 (-0.0003943945f, -0.04917584f, -0.05477962f)) {
					arrowForward3.transform.localPosition = Vector3.MoveTowards (arrowForward3.transform.localPosition, new Vector3 (0.0005618262f, 0.0002853314f, -0.04771918f), m_ScriptM.speedForward * Time.deltaTime);
				}
					if (endPos_Arrow5 == new Vector3 (0.004825752f, -0.08844844f, -0.141324f)) {
					arrowForward4.transform.localPosition = Vector3.MoveTowards (arrowForward4.transform.localPosition, new Vector3 (-0.0003943945f, -0.04917584f, -0.05477962f), m_ScriptM.speedForward * Time.deltaTime);
				}
				arrowForward5.transform.localPosition = Vector3.MoveTowards (arrowForward5.transform.localPosition, new Vector3 (0.004825752f, -0.08844844f, -0.141324f), m_ScriptM.speedForward * Time.deltaTime);
			}
			SoundPitchManip ();
		} else if (Input.GetKey (m_ScriptM.forwardArrow) && block_For == true) {
			if (checkManip == 1 || checkManip == 2) {
				arrowForward2.transform.localPosition = Vector3.MoveTowards (arrowForward2.transform.localPosition, new Vector3 (0.0006269385f, 0.1260378f, -3.562f), m_ScriptM.speedForward * Time.deltaTime);
				if (endPos_Arrow2 == new Vector3 (0.0006269385f, 0.1260378f, -3.562f)) {
					arrowForward3.transform.localPosition = Vector3.MoveTowards (arrowForward3.transform.localPosition, new Vector3 (0.0006604248f, -0.06289651f, -3.471f), m_ScriptM.speedForward * Time.deltaTime);
				}
				if (endPos_Arrow3 == new Vector3 (0.0006604248f, -0.06289651f, -3.471f)) {
					arrowForward4.transform.localPosition = Vector3.MoveTowards (arrowForward4.transform.localPosition, new Vector3 (0.005361533f, -0.05230227f, -3.469f), m_ScriptM.speedForward * Time.deltaTime);
				}
		} else if (checkManip == 3) {
				arrowForward2.transform.localPosition = Vector3.MoveTowards (arrowForward2.transform.localPosition, new Vector3 (-0.01917278f, 0.07633314f, -6.513f), m_ScriptM.speedForward * Time.deltaTime);
				if (endPos_Arrow2 == new Vector3 (-0.01917278f, 0.07633314f, -6.513f)) {
					arrowForward3.transform.localPosition = Vector3.MoveTowards (arrowForward3.transform.localPosition, new Vector3 (0.0005618262f, 0.0002853314f, -3.065f), m_ScriptM.speedForward * Time.deltaTime);
				}
				if (endPos_Arrow3 == new Vector3 (0.0005618262f, 0.0002853314f, -3.065f)) {
					arrowForward4.transform.localPosition = Vector3.MoveTowards (arrowForward4.transform.localPosition, new Vector3 (-0.0003943945f, -0.04917584f, -3.109f), m_ScriptM.speedForward * Time.deltaTime);
				}
				if (endPos_Arrow4 == new Vector3 (-0.0003943945f, -0.04917584f, -3.109f)) {
					arrowForward5.transform.localPosition = Vector3.MoveTowards (arrowForward5.transform.localPosition, new Vector3 (0.004825752f, -0.08844844f, -3.22f), m_ScriptM.speedForward * Time.deltaTime);
				}
			}
			SoundPitchManip ();
		}
	...
	public void Lift_Horizontal_FL(){
		if (checkManip == 1 && panelManipFL_Button_Bool == false) {
			if (support_FL_Horizontal_Bool == true) {
				support_FL_Horizontal.transform.localPosition = Vector3.MoveTowards (support_FL_Horizontal.transform.localPosition, new Vector3 (-1.24601f, -0.1445284f, -0.06621829f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			} else if (support_FL_Horizontal_Bool == false) {
				support_FL_Horizontal.transform.localPosition = Vector3.MoveTowards (support_FL_Horizontal.transform.localPosition, new Vector3 (-2.656f, -0.145f, -0.06621829f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			}
			SoundPitchManip ();
		} else if (checkManip == 2 && panelManipFL_Button_Bool == false) {
			if (support_FL_Horizontal_Bool == true) {
				support_FL_Horizontal.transform.localPosition = Vector3.MoveTowards (support_FL_Horizontal.transform.localPosition, new Vector3 (-1.24601f, -0.1305281f, -0.06621457f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			} else if (support_FL_Horizontal_Bool == false) {
				support_FL_Horizontal.transform.localPosition = Vector3.MoveTowards (support_FL_Horizontal.transform.localPosition, new Vector3 (-2.611f, -0.131f, -0.06621457f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			}
			SoundPitchManip ();
		} else if (checkManip == 3 && panelManipFL_Button_Bool == false) {
			if (support_FL_Horizontal_Bool == true) {
				support_FL_Horizontal.transform.localPosition = Vector3.MoveTowards (support_FL_Horizontal.transform.localPosition, new Vector3 (-1.175445f, -0.1384991f, -0.04297363f), m_ScriptM.speedLiftTruck * Time.deltaTime);

			} else if (support_FL_Horizontal_Bool == false) {
				support_FL_Horizontal.transform.localPosition = Vector3.MoveTowards (support_FL_Horizontal.transform.localPosition, new Vector3 (-2.616f, -0.1384991f, -0.04297363f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			}
			SoundPitchManip ();
		}
	}
	...
	public void Lift_Horizontal_FR(){
		if (checkManip == 1 && panelManipFR_Button_Bool == false) {
			if (support_FR_Horizontal_Bool == true) {
				support_FR_Horizontal.transform.localPosition = Vector3.MoveTowards (support_FR_Horizontal.transform.localPosition, new Vector3 (1.241764f, -0.1445291f, -0.06622003f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			} else if (support_FR_Horizontal_Bool == false) {
				support_FR_Horizontal.transform.localPosition = Vector3.MoveTowards (support_FR_Horizontal.transform.localPosition, new Vector3 (2.658f, -0.145f, -0.06622003f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			}
			SoundPitchManip ();
		} else if (checkManip == 2 && panelManipFR_Button_Bool == false) {
			if (support_FR_Horizontal_Bool == true) {
				support_FR_Horizontal.transform.localPosition = Vector3.MoveTowards (support_FR_Horizontal.transform.localPosition, new Vector3 (1.221479f, -0.1305281f, -0.06621899f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			} else if (support_FR_Horizontal_Bool == false) {
				support_FR_Horizontal.transform.localPosition = Vector3.MoveTowards (support_FR_Horizontal.transform.localPosition, new Vector3 (2.622f, -0.131f, -0.06621899f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			}
			SoundPitchManip ();
		} else if (checkManip == 3 && panelManipFR_Button_Bool == false) {
			if (support_FR_Horizontal_Bool == true) {
				support_FR_Horizontal.transform.localPosition = Vector3.MoveTowards (support_FR_Horizontal.transform.localPosition, new Vector3 (1.228052f, -0.1384991f, -0.04297502f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			} else if (support_FR_Horizontal_Bool == false) {
				support_FR_Horizontal.transform.localPosition = Vector3.MoveTowards (support_FR_Horizontal.transform.localPosition, new Vector3 (2.623f, -0.1384991f, -0.04297502f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			}
			SoundPitchManip ();
		}
	}
	...
	public void Lift_Vertical_FL(){
		if (checkManip == 1 && panelManipFL_Button_Bool == false) {
			if (support_FL_Vertical_Bool == true) {
				support_FL_Vertical.transform.localPosition = Vector3.MoveTowards (support_FL_Vertical.transform.localPosition, new Vector3 (0.04820915f, -1.00017f, 0.03412036f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			} else if (support_FL_Vertical_Bool == false) {
				support_FL_Vertical.transform.localPosition = Vector3.MoveTowards (support_FL_Vertical.transform.localPosition, new Vector3 (0.048f, -1.959f, 0.03412036f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			}
			SoundPitchManip ();
		} else if (checkManip == 2 && panelManipFL_Button_Bool == false) {
			if (support_FL_Vertical_Bool == true) {
				support_FL_Vertical.transform.localPosition = Vector3.MoveTowards (support_FL_Vertical.transform.localPosition, new Vector3 (0.02299581f, -0.7332212f, 0.03411815f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			} else if (support_FL_Vertical_Bool == false) {
				support_FL_Vertical.transform.localPosition = Vector3.MoveTowards (support_FL_Vertical.transform.localPosition, new Vector3 (0.02299581f, -2.691f, 0.03411815f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			}
			SoundPitchManip ();
		} else if (checkManip == 3 && panelManipFL_Button_Bool == false) {
			if (support_FL_Vertical_Bool == true) {
				support_FL_Vertical.transform.localPosition = Vector3.MoveTowards (support_FL_Vertical.transform.localPosition, new Vector3 (0.00499923f, -1.007683f, -0.01323524f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			} else if (support_FL_Vertical_Bool == false) {
				support_FL_Vertical.transform.localPosition = Vector3.MoveTowards (support_FL_Vertical.transform.localPosition, new Vector3 (0.00499923f, -1.96f, -0.01323524f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			}
			SoundPitchManip ();
		}
	}
	...
	public void Lift_Vertical_FR(){
		if (checkManip == 1 && panelManipFR_Button_Bool == false) {
			if (support_FR_Vertical_Bool == true) {
				support_FR_Vertical.transform.localPosition = Vector3.MoveTowards (support_FR_Vertical.transform.localPosition, new Vector3 (-0.04887562f, -1.00017f, 0.03412036f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			} else if (support_FR_Vertical_Bool == false) {
				support_FR_Vertical.transform.localPosition = Vector3.MoveTowards (support_FR_Vertical.transform.localPosition, new Vector3 (-0.04887562f, -1.906f, 0.03412036f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			}
			SoundPitchManip ();
		} else if (checkManip == 2 && panelManipFR_Button_Bool == false) {
			if (support_FR_Vertical_Bool == true) {
				support_FR_Vertical.transform.localPosition = Vector3.MoveTowards (support_FR_Vertical.transform.localPosition, new Vector3 (-0.02433154f, -0.7332211f, 0.03411908f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			} else if (support_FR_Vertical_Bool == false) {
				support_FR_Vertical.transform.localPosition = Vector3.MoveTowards (support_FR_Vertical.transform.localPosition, new Vector3 (-0.02433154f, -2.691f, 0.03411908f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			}
			SoundPitchManip ();
		} else if (checkManip == 3 && panelManipFR_Button_Bool == false) {
			if (support_FR_Vertical_Bool == true) {
				support_FR_Vertical.transform.localPosition = Vector3.MoveTowards (support_FR_Vertical.transform.localPosition, new Vector3 (-0.006394029f, -1.007683f, -0.01323454f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			} else if (support_FR_Vertical_Bool == false) {
				support_FR_Vertical.transform.localPosition = Vector3.MoveTowards (support_FR_Vertical.transform.localPosition, new Vector3 (-0.006394029f, -1.96f, -0.01323454f), m_ScriptM.speedLiftTruck * Time.deltaTime);
			}
			SoundPitchManip ();
		}
	}
